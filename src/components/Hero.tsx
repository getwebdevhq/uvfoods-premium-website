  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          src="/images/hero.png"
          alt="Sustainable agricultural landscape at sunrise"
          ...
          <div className="lg:col-span-3">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 mb-8">
                ...
                <span className="text-white/80 text-sm font-medium">Trusted Since 1986</span>
              </div>
            </motion.div>

            <motion.h1
              className="font-heading font-bold text-display-xl text-white mb-6 text-balance"
            ...
            >
              Modern food manufacturing and nutrition solutions built for institutional programs, public welfare, and sustainable impact across India.
            </motion.p>
            ...
            <div className="glass rounded-3xl p-8 animate-float">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { value: '600+', label: 'Districts Served' },
                  { value: '280+', label: 'MT Daily Production' },
                ].map((stat) => (
